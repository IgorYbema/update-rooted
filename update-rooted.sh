...
echo ""
echo "Version: 4.20  - TheHogNL & TerrorSource & yjb - 9-05-2020"
echo ""
...
getVersion() {
	...
	then
		...
		then
			...
			VERSION="5.0.6"
		elif [ "$ARCH" == "nxt" ] && [ $CURVERS_MAJOR -lt 5 ] && [ $VERS_MAJOR -ge 5 ] && [ "$VERSION" != "5.0.4" ]
		then
			echo "You need to upgrade to 5.0.4 first due to problems with later firmware upgrades!" 
			VERSION="5.0.4"
		else
